...
export default function SaudeMental() {
  const { data, loading, error } = useStaticData<{ artigos: Artigo[] }>("artigos-saude-mental");
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center py-12">
            ...
            <p className="text-red-600">Erro ao carregar artigos de saúde mental. Por favor, tente novamente mais tarde.</p>
          </div>
        </div>
        <Footer />
      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-0 pt-6 sm:py-2 sm:pt-12">
        <div className="mb-6">
          <div className="flex items-center justify-center mb-2 sm:mb-4">
            ...
            <span className="text-3xl lg:text-4xl font-bold text-blue-600 ml-2">Trend</span>
            <span className="text-3xl lg:text-4xl font-bold text-gray-900 ml-2">Saúde Mental</span>
          </div>
          <p className="text-xl text-gray-600 text-center">
            Dicas, técnicas e recursos para cuidar da sua saúde mental e bem-estar.
          </p>
        </div>
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-gray-600">
                Volte em breve para ver os últimos artigos de saúde mental.
              </p>
            </CardContent>
          </Card>
        )}
